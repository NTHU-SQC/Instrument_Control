...
class GenericWave():
    ...
    @property
    def xaxis(self):
        return self.__class__.axis('t', 'time (ns)', self._x, False)

    @property
    def faxis(self):
        return self.__class__.axis('t', 'time (ns)', fftshift(self.f), False)

    @property
    def yfaxis(self):
        return self.__class__.axis('t', 'time (ns)', fftshift(self.yf), False)
...
class Wave(GenericWave):
    ...
    def __init__(self, funcHandle=None, variables=[], properties={}):
        ...
        self._y = deepcopy(self.__properties['wave_amp'])
        self._x = deepcopy(self.__properties['pulsewidth'])
